...
Route::get('/change-soft-status/{value}/{id}', 'ProvideSoftskillController@change_current_status');
Route::post('/soft-status/course-follow', 'ProvideSoftskillController@add_status_course');

Route::get('/change-vt-status/{value}/{id}', 'FinancialSupportController@change_current_status');
Route::post('/vt-status/course-follow', 'FinancialSupportController@add_status_course');

Route::get('/change-gvt-status/{value}/{id}', 'CourseSupportController@change_current_status');
Route::post('/gvt-status/course-follow', 'CourseSupportController@add_status_course');
