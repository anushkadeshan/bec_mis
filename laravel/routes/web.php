...
Route::post('/vacancy/apply', 'VacancyController@apply')->name('apply-vacancy')->middleware('can:apply-vacancies'); 
...
Route::get('/youth/view', 'YouthController@index')->name('youth/view')->middleware('can:view-youth');
