...
<?php $__env->startSection('title','Job Placement |'); ?>
...
var dataTable4 = $("#example11").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/job/placements/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/job/placements')); ?>" +'/' + meeting_id +'/view', function (data) {
...
$('body').on('click', '.btn_view2', function () {
      ...
      $.get("<?php echo e(url('reports-me/job/ind-placements')); ?>" +'/' + meeting_id +'/view', function (data) {
...
google.charts.load('current', {'packages':['corechart']});
      ...
      var data1 = google.visualization.arrayToDataTable([
        ...
        ["0-4999", <?php echo e($salary1); ?>, "blue"],
        ["5000-9999", <?php echo e($salary2); ?>, "orange"],
        ["10000-14999", <?php echo e($salary3); ?>, "green"],
        ["15000-19999", <?php echo e($salary4); ?>, "purple"],
        ["20000-24999", <?php echo e($salary5); ?>, "brown"],
        ["Above 25000", <?php echo e($salary6); ?>, "red"],
      ]);
