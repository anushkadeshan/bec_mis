...
<?php $__env->startSection('title','Individual Placements |'); ?>
	            	...
	            	<div class="col-md-8">
	            		<div class="form-group">
						    ...
						    <select name="title_of_action" id="title_of_action" class="form-control">
								...
								<option <?php if($activity->activity=='Youth placed in private sectors'): ?> selected <?php endif; ?> value="<?php echo e($activity->activity); ?>"><?php echo e($activity->activity); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="activity_code" id="activity_code" class="form-control">
								<option value="">Select Option</option>
								<?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($activity->code=='4.2.4'): ?> selected <?php endif; ?> value="<?php echo e($activity->code); ?>"><?php echo e($activity->code); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
	            ...
	            <div class="row">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
                      	...
                      	<input type="hidden" id="employer_id" name="employer_id" class="form-control" value="" >
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
                      	...
                      	<input type="hidden" id="youth_id" name="youth_id" class="form-control" value="" >
						</div>
	            	</div>
	            </div>	
	            <div class="row">
	          		<div class="col-md-4">
	          			<div class="form-group">
						    ...
						    <input type="text" name="type_of_support" class="form-control position-list">
						</div>
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
...
$(document).ready(function(){
     $("#res_person").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/job-linking/add-individual',   
            ...
            success: function(data) {
              ...
              toastr.success('Succesfully Add individual Placements Details ! ', 'Congratulations', {timeOut: 5000});
			  $("#res_person")[0].reset();
