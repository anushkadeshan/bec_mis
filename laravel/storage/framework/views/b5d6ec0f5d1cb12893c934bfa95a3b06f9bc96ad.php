<?php $__env->startSection('title','Soft Skills |'); ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Soft Skills Training <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h4>
          </div>
          <div class="col-md-4">
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab_1">
                    <div>
                      ...
                      <a class="btn btn-app zoom">
                        <span class="badge bg-warning" id=""><?php echo e($ongoing); ?></span>
                        <i class="fa fa-running"></i>Ongoing Courses
                      </a>
                      <a class="btn btn-app zoom">
                      ...
                      <a class="btn btn-app zoom">
                        ...
                        <i class="fa fa-dollar-sign"></i> Cost
                      </a>
                    </div>
                                    ...
                                    <tbody>
                                      ...
                                      <?php $__currentLoopData = $youths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $youth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <tr>
                                          ...
                                          <td><a href="<?php echo e(URL::to('youth/' . $youth->youth_id . '/view')); ?>"><?php echo e($youth->youth_name); ?></a></td>
                                          ...
                                          <td>
                                              ...
                                              ?>
                                            <select
                                              <?php if($youth->end_date > date("Y-m-d")|| !is_null($job)||!is_null($vt)|| $youth->cs == 2): ?> disabled <?php endif; ?>
                                              name="current_status" id="current_status" class="form-control" onchange="updateStatus(this.value,<?php echo e($youth->youth_id); ?>)">
                                              <option <?php if($youth->cs==5): ?> selected <?php endif; ?> value="5">No Job</option>
                                              <option <?php if($youth->end_date > date("Y-m-d")): ?> selected <?php endif; ?> value="1">Still Following Course</option>
                                              <option <?php if(!is_null($vt) || $youth->cs == 2): ?> selected <?php endif; ?> value="2">Following Course-BEC Supported</option>
                                              <option <?php if($youth->cs==3): ?> selected <?php endif; ?> value="3">Following Course-BEC Not Supported</option>
                                              <option <?php if(!is_null($job)): ?> selected <?php endif; ?> value="4">On the Job</option>
                                              <option <?php if($youth->cs==6): ?> selected <?php endif; ?> value="6">Not Contactable</option>
                                            </select>
                    ...
                    <div class="card card-success">
                    <div  class="card-header">
                     Enrolled Youths to soft skill training <a href="<?php echo e(Route('view_soft_youths')); ?>"><span  class="badge badge-warning float-right" id="row_count">View Youth Report</span></a>
                    </div>
                    <div  class="card-body">
                  ...
                  <div class="tab-pane print" id="tab_3">
                    <div class="row">
                          ...
                          <div class="card-header">
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-7">
                                <li class="list-group-item border-0"><strong>Institute Review Done? : </strong><br><span id="review"></span></li>
                                </div>
                              </div>
                              <div class="row">
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>MOU signed? : </strong><br><span id="mou"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong> Date signed ? : </strong><br><span id="date"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong> Cost ? : </strong><br><span id="cost"></span></li>
                                </div>
                              </div>
                              </fieldset>
                              <fieldset class="border p-2 list-group-flush">
                              <legend  class="w-auto text-primary"><small> Course Details</small></legend>
                              <div class="row">
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>Training Stage : </strong><br> <span id="training_stage"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>Start Date: </strong><br>  <span id="s-date"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>End Date: </strong><br>  <span id="e-date"></span></li>
                                </div>
                              </div>
                              </fieldset>
                      ...
                      <div class="col-md-6">
                        ...
                        <a id="link2" href="" target="_blank">  <button type="button" id="download_a" name="file_name" class="btn btn-warning btn-flat" data-id="" data-attendance=""><i class="fas fa-download"></i> MOU Report</button></a>
                        <?php echo e(csrf_field()); ?>
...
var dataTable2 = $("#example10").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/skill/soft-skill/fetch')); ?>",
   method:"POST",
  ...
  dataTable.clear().draw();
   ...
   dataTable2.clear().draw();
    ...
    dataTable2.row.add([count2++, value2.name, value2.progs, value2.male, value2.female, value2.male+value2.female,value2.dropout,value2.status, parseFloat(value2.total_cost).toLocaleString()]).draw();
    });

  $.each(data.data, function(index, value) {
    //console.log(value);
    // use data table row.add, then .draw for table refresh
    dataTable.row.add([count++, value.meeting_date, value.total_male, value.total_female, value.institute_name,value.end_date,value.cost,value.ext,'<div class="btn-group"><button type="button" name="view" data-id="'+value.m_id+'" class="btn btn-warning btn-flat btn-sm btn_view"><i class="fa fa-eye"></i></button><a href="<?php echo e(url('reports-me/soft-skill')); ?>/'+value.m_id+'/edit"><button type="button" name="view" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></button></a></div>']).draw();
     ...
     if ($.isNumeric(total_male,total_female,total_p_male,total_p_female,total_cost)) {
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/skill/soft-skill')); ?>" +'/' + meeting_id +'/view', function (data) {
          ...
          $('#mou').text(data.meeting.mou_signed);
          $('#date').text(data.meeting.date_signed);
          $('#cost').text(data.meeting.cost);
          ...
          var mou = data.meeting.mou_report;
          var url2 = SITE_URL+ '/download/soft-skill/'+mou;
          ...
          for(var count = 0; count < data.youths.length; count++)
          {
           ...
           output1 += '<td>' + data.youths[count].phone + '</td></tr>';
          }
