          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
              <div class="row">
                ...
                <option value="<?php echo e($meeting->dsd); ?>"><?php echo e($meeting->dsd); ?></option>
                 </select>
            </div>
                </div>
                <div class="col-md-3">
                ...
                <option value="<?php echo e($meeting->dm_name); ?>"><?php echo e($meeting->dm_name); ?></option>
                 </select>
            </div>
                </div>
              </div>
              <div class="row">
                ...
                <input type="date" name="program_date" id="meeting_date" class="form-control" value="<?php echo e($meeting->program_date); ?>">
            </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                ...
                <input type="text" name="program_cost" id="program_cost" class="form-control" value="<?php echo e($meeting->program_cost); ?>">
            </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <textarea class="textarea" name="mode_of_conduct" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->mode_of_conduct); ?></textarea>
            </div>
                </div>                
              </div>
              <div class="row">
                ...
                <textarea class="textarea" name="topics" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->topics); ?></textarea>
            </div>
                </div>                
              </div>
              <div class="row">
                ...
                <textarea class="textarea" name="deliverables" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->deliverables); ?></textarea>
                </div>
                </div>                
              </div>
               <div class="row">
                ...
                <label for="family_id">Resourse Person</label>
                        ...
                        <input data-toggle="tooltip" data-placement="top" title="Search Resorse Person name and select" type="text" id="res_name" name="res_id" class="form-control" placeholder="Search Name of Resourse Person" value="<?php echo e($meeting->r_name); ?>">
                        <div style="cursor: pointer" onclick="window.open('<?php echo e(Route('activities/resourse-person')); ?>', '_blank');" class="input-group-prepend">
                      ...
                      <div id="res_list"></div>
                      <input type="hidden" id="resourse_person_id" name="resourse_person_id" value="<?php echo e($meeting->resourse_person_id); ?>">
          </div> 
              </div>
            ...
            <div class="tab-pane" id="tab_3">
              ...
              <tbody>
                ...
                <tr>
                  <th><?php echo e($participant->name); ?></th>
                  <td><?php echo e($participant->type); ?></td>
                  <td><?php echo e($participant->address); ?></td>
                  <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($participant->id); ?>" data-name="<?php echo e($participant->name); ?>" data-type="<?php echo e($participant->type); ?>" data-address="<?php echo e($participant->address); ?>" id="edit2"><i class="fa fa-edit"></i></button></td>
                </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="tab-pane" id="tab_4">
              ...
              <tbody>
                <?php $__currentLoopData = $cg_youths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $youth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <th><?php echo e($youth->name); ?></th>
                  <td><?php echo e($youth->career_field1); ?></td>
                  <td><?php echo e($youth->career_field2); ?></td>
                  <td><?php echo e($youth->career_field3); ?></td>
                  <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($youth->cg_youths_id); ?>" data-name="<?php echo e($youth->name); ?>" data-career_field1="<?php echo e($youth->career_field1); ?>" data-career_field2="<?php echo e($youth->career_field2); ?>" data-career_field3="<?php echo e($youth->career_field3); ?>" id="edit3"><i class="fas fa-edit"></i></button>
                  <button type="button" class="btn btn-danger btn-flat btn-sm" id="deleteYouth" data-id="<?php echo e($youth->cg_youths_id); ?>"><i class="fas fa-trash"></i></button>
    ...
    <h5>Add a new youth (if you have missed)</h5>
              <div class="row container" style="background-color: #5E6971; color: white; padding: 15px">
                ...
                <div class="input-group">                       
                            ...
                            <div style="cursor: pointer" onclick="window.open('<?php echo e(Route('youth/add')); ?>', '_blank');" class="input-group-prepend">
              ...
              <tbody>
                <?php $__currentLoopData = $cg_youth_selected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cg_ys): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>                  
                  <th><label><?php echo e($cg_ys->requirement); ?></label></th>
                  <td><?php echo e($cg_ys->male); ?></td>
                  <td><?php echo e($cg_ys->female); ?></td>
                  <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($cg_ys->id); ?>" data-male="<?php echo e($cg_ys->male); ?>" data-female="<?php echo e($cg_ys->female); ?>"  id="edit4"><i class="fas fa-edit"></i></button></td>
                </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <div class="tab-pane" id="tab_5">
              ...
              <tbody>
                <?php $__currentLoopData = $cg_careertest_summary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  <th><label><?php echo e($cts->career_field); ?></label></th>
                  <td><?php echo e($cts->male); ?></td>
                  <td><?php echo e($cts->female); ?></td>
                  <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($cts->id); ?>" data-male="<?php echo e($cts->male); ?>" data-female="<?php echo e($cts->female); ?>"  id="edit5"><i class="fas fa-edit"></i></button></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
