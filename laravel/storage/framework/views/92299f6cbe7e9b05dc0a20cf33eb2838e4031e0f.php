	            ...
	            <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="program_date" id="review_date" class="form-control" value="<?php echo e($meeting->program_date); ?>">
						</div>
	            	</div>
	            </div>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <div class="input-group">                       
		                        <input data-toggle="tooltip" data-placement="top" title="Search Institute name and select" type="text" id="ins_name" name="res_id" class="form-control" placeholder="Search Name of Institute" value="<?php echo e($meeting->institute_name); ?>">
                      	...
                      	<div id="is_list"></div>
                          <input type="hidden" id="institute_id" name="institute_id" value="<?php echo e($meeting->institute_id); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    <label for="institutional_review">8.Head of Institute </label>
						    <input type="text" id="head_of_institute" name="head_of_institute" class="form-control" value="<?php echo e($meeting->head_of_institute); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    <label for="institutional_review">9. Contact No</label>
						    <input type="number" id="contact" name="contact" class="form-control" value="<?php echo e($meeting->contact); ?>">
						</div>
	            	</div>
	            </div>
	            <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" id="commencement_date" name="commencement_date" class="form-control" value="<?php echo e($meeting->commencement_date); ?>">
						</div>
	            	</div>
	            	<div class="col-md-5">
	            		<div class="form-group">
						    <label for="institutional_review">11. if TVEC regiestered, Expiry date of registration</label>
						    <input type="date" id="tvec_ex_date" name="tvec_ex_date" class="form-control" value="<?php echo e($meeting->tvec_ex_date); ?>">
						</div>
	            	</div>
	            </div>
	            <div style="width: 100%; height: 20px; border-bottom: 1px solid blue; text-align: center;padding-bottom: 10px">
                ...
                <div class="row">
	            	...
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <select name="ojt_compulsory" id="ojt_compulsory" class="form-control">
								...
								<option <?php if($meeting->ojt_compulsory=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->ojt_compulsory=="No"): ?> selected <?php endif; ?> value="No">No</option>
    					   </select>
	            	...
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <textarea name="courses_not_compulsory" id="courses_not_compulsory" class="form-control"><?php echo e($meeting->courses_not_compulsory); ?></textarea>
						</div>
	            	</div>
	            	...
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <select name="followup" id="followup" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->followup=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->followup=="No"): ?> selected <?php endif; ?> value="No">No</option>
    					   </select>
						</div>
	            	</div>
	            	<?php 
	            		...
	            		<div class="form-group">
						    ...
						    <select name="services_offered[]" id="services_offered" class="form-control" multiple>
								<?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option><?php echo e($service); ?></option>                                 
            		...
            		<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="trainee_allowance" id="trainee_allowance" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->trainee_allowance=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->trainee_allowance=="No"): ?> selected <?php endif; ?> value="No">No</option>
    					   </select>
						</div>
            		</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <input type="number" id="amount" name="amount" class="form-control" value="<?php echo e($meeting->amount); ?>">
						</div>
	            	</div>
	            	<div class="col-md-5">
	            		<div class="form-group">
						    <label for="courses_not_compulsory">19. Source/s of funding for trainee allowance? </label>  
					    <input type="text" id="source" name="source" class="form-control" value="<?php echo e($meeting->source); ?>">
						</div>
            		</div>
            	</div>
	            <div class="row">
            		<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <select name="soft_skill" id="soft_skill" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->soft_skill=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->soft_skill=="No"): ?> selected <?php endif; ?> value="No">No</option>
								<option <?php if($meeting->soft_skill=="Need improvements"): ?> selected <?php endif; ?> value="Need improvements">Need improvements</option>
    					   </select>
						</div>
            		</div>
            		<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <select name="agreement_soft_skill" id="agreement_soft_skill" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->agreement_soft_skill=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->agreement_soft_skill=="No"): ?> selected <?php endif; ?> value="No">No</option>
								<option <?php if($meeting->agreement_soft_skill=="Not decided"): ?> selected <?php endif; ?> value="Not decided">Not decided</option>
    					   </select>
						</div>
            		</div>
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <textarea name="gaps" id="gaps" class="form-control"><?php echo e($meeting->gaps); ?></textarea>
						</div>
	            	</div>
	          ...
	          <div class="tab-pane" id="tab_2">
	          	...
	          	<div class="form-group">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <th><?php echo e($course->name); ?></th>
						      <td><?php echo e($course->period_intake); ?></td>
						      <td><?php echo e($course->intake_per_batch); ?></td>
						      <td><?php echo e($course->current_following); ?></td>
						      <td><?php echo e($course->passed_out); ?></td>
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($course->i_id); ?>" data-period_intake="<?php echo e($course->period_intake); ?>" data-current_following="<?php echo e($course->current_following); ?>" data-intake_per_batch="<?php echo e($course->intake_per_batch); ?>" data-passed_out="<?php echo e($course->passed_out); ?>" id="edit2"><i class="fas fa-edit"></i></button></td>
						    </tr>
						    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						  </tbody>
						</table>
