	          		...
	          		<div class="col-md-4">
	          			<div class="form-group">
						    ...
						    <select name="dsd" id="dsd" class="form-control">
								<option value=""><?php echo e($meeting->DSD_Name); ?></option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="institutional_review" id="institutional_review" class="form-control">
								...
								<option <?php if($meeting->institutional_review=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->institutional_review=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            ...
	            <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="mou_signed" id="mou_signed" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->mou_signed=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->mou_signed=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="date_signed" id="date_signed" class="form-control" value="<?php echo e($meeting->date_signed); ?>">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="number" name="cost" id="cost" class="form-control" value="<?php echo e($meeting->cost); ?>">
                ...
                <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="training_stage" id="training_stage" class="form-control">
								<option value="">Select Option</option>
								<option <?php if($meeting->training_stage=="Prior to VT/Professional training"): ?> selected <?php endif; ?> value="Prior to VT/Professional training">Prior to VT/Professional training</option>
								<option <?php if($meeting->training_stage=="During the VT/Professional training"): ?> selected <?php endif; ?> value="During the VT/Professional training">During the VT/Professional training</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo e($meeting->start_date); ?>">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="end_date" id="end_date" class="form-control" value="<?php echo e($meeting->end_date); ?>">
	          	...
	          	<div class="form-group">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($youth->c_id); ?>" data-dropout="<?php echo e($youth->dropout); ?>" data-reoson="<?php echo e($youth->reoson_to_dropout); ?>" id="edit2"><i class="fas fa-edit"></i></button></td>
						    </tr>
	          		...
	          		<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <div class="input-group">
		                        ...
		                        <div style="cursor: pointer" onclick="window.open('<?php echo e(url('activities/skill-development/institute-review')); ?>', '_blank');" class="input-group-prepend">
						  ...
						  <tbody>
						    <tr>
						      ...
						      <?php echo e(csrf_field()); ?>
              				  ...
              				  <input type="hidden" id="r_id" name="m_id" value="<?php echo e($meeting->m_id); ?>">
              				  <input type="hidden" id="edate" name="edate" value="<?php echo e($meeting->end_date); ?>">
						      </form>
						    </tr>
