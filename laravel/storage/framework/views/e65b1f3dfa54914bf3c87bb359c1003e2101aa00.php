      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <h3>1.2.2 Mentoring program <small class="badge badge-success"> <?php echo e(count($mentorings)); ?></small></h3>
          </div>
          <div class="col-md-6">
            	...
            	<?php echo e(csrf_field()); ?>
                  ...
                  <div class="tab-pane print" id="tab_3">
                    <div class="row">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('verify-report')): ?>
                        <br>  
                        <br>  
                        <div  class="form-group">
...
var dataTable = $("#example").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(route('reports-me/education/mentoring/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(route('reports-me/education/mentoring')); ?>" +'/' + meeting_id +'/view', function (data) {
