...
<?php $__env->startSection('title','Incoperation Soft Skills |'); ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Incorporation of soft skill component <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h4>
          </div>
          <div class="col-md-4">
...
var dataTable2 = $("#example10").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/skill/incoperate-soft-skills/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/skill/incoperate-soft-skills')); ?>" +'/' + meeting_id +'/view', function (data) {
