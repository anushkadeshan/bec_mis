...
<?php $__env->startSection('title','Vacancies |'); ?>
    ...
    <div class="card">
        <div class="card-header">
        	<div class="row">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-vacancies')): ?>
        		<div class="col-md-2 text-right">
        			<!-- Button trigger modal -->
					<a href="<?php echo e(ROUTE('new-vacancy')); ?>"><button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#updateModel">Add Vacancy</button></a>
        		</div>
                <?php endif; ?>
        	</div>
        </div>
            ...
            <table id="example" class="table row-border table-hover" style="width:100%">
                <thead>
                    <tr>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-vacancies')): ?>
                        <th>Action</th>
                        <?php endif; ?>
                    </tr>
                </thead> 
                <tbody>
                    ...
                    <tr id='clickable-row' style="cursor: pointer" data-href='<?php echo e(URL::to('vacancy/' . $vacancy->id . '/view')); ?>' class="vacancy<?php echo e($vacancy->id); ?>">
                        <td><?php echo e($no++); ?></td>
                        <td><a href="<?php echo e(URL::to('vacancy/' . $vacancy->id . '/view')); ?>"><?php echo e($vacancy->title); ?></a>
                            <br><i class="fas fa-clock fa-xs"><small> <?php echo e($vacancy->dedline); ?></small>
                        </td>
                        <td><?php echo e($vacancy->employer->name); ?></td>
                        <td><?php echo e($vacancy->job_type); ?></td>
                        <td><?php echo e($vacancy->location); ?></td>
                        <td><?php echo e($vacancy->specializaion); ?></td>
                        <td><?php echo e($vacancy->business_function); ?></td>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-vacancies')): ?>
                        <td>
                            <div class="btn-group">
                                <a href="<?php echo e(URL::to('vacancy/' . $vacancy->id . '/edit')); ?>">
                                    <button type="submit" id="edit-vacancy" data-id="<?php echo e($vacancy->id); ?>" class="btn btn-block btn-success btn-flat btn-sm"><i class="fas fa-edit"></i></button>
                                </a>
                                <form id="userDelete" method="post" >
                                <?php echo e(csrf_field()); ?>

                                    <button type="button" id="delete-vacancy" data-id="<?php echo e($vacancy->id); ?>" class="btn btn-block btn-danger btn-flat btn-sm"><i class="fas fa-trash-alt"></i></button>
                                </form>
                            </div>
