...
<?php $__env->startSection('title','Partnership Trainings |'); ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Partnership Training <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h4>
          </div>
          <div class="col-md-4">
                  ...
                  <div class="tab-pane print" id="tab_3">
                    <div class="row">
                        ...
                        <div class="card card-success card-outline">
                          <div class="card-header">
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <fieldset class="border p-2 list-group-flush">
                              <legend  class="w-auto text-primary"><small> Cost of Support</small></legend>
                              <div class="row">
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>BEC : </strong><span id="bec"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>Partner: </strong><br>  <span id="partner"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>Student: </strong><br>  <span id="student"></span></li>
                                </div>
                                <div class="col-md-4">
                                <li class="list-group-item border-0"><strong>Total: </strong><br>  <span id="total"></span></li>
                                </div>
                              </div>
                              </fieldset>
                      ...
                      <div class="col-md-6">
                        ...
                        <button type="button hidden-print" id="print" class="btn btn-success btn-flat"><i class="fas fa-print"></i></button>
                       <button type="button" id="review_id" name="file_name" class="btn btn-primary btn-flat" data-id="" data-attendance=""><i class="fas fa-download"></i> Review Report</button>
                        <a id="link4" href="" target="_blank">  <button type="button" id="download_a" name="file_name" class="btn btn-warning btn-flat" data-id="" data-attendance=""><i class="fas fa-download"></i> MOU Report</button></a>
                        <a id="link5" href="" target="_blank">  <button type="button" id="download_a" name="file_name" class="btn btn-default btn-flat" data-id="" data-attendance=""><i class="fas fa-download"></i> Photo</button></a>
...
var dataTable = $("#example").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(url('reports-me/skill/partnership/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/skill/partnership')); ?>" +'/' + meeting_id +'/view', function (data) {
          ...
          $('#date').text(data.meeting.date_mou_signed);
          $('#bec').text(data.meeting.bec_contribution);
          $('#partner').text(data.meeting.partner_contribution);
          $('#student').text(data.meeting.student_contribution);
          $('#total').text(data.meeting.total_cost);
          ...
          var url4 = SITE_URL+ '/download/partnership/'+mou;
          $("#link4").attr("href",url4);

          var photo = data.meeting.group_photo;
          var url5 = SITE_URL+ '/download/partnership/group-photo/'+photo;
          $("#link5").attr("href",url5);
          ...
          for(var count = 0; count < data.youths.length; count++)
          {
           ...
           output1 += '<td>' + data.youths[count].approved_amount + '</td></tr>';
          }
...
$('body').on('click', '#review_id', function () {
     ...
     // alert(meeting_id);
      ...
      $.get("<?php echo e(url('reports-me/skill/institute-review')); ?>" +'/' + meeting_id +'/view', function (data) {
          ...
          $('#s-date1').text(data.meeting.start_date);
          $('#e-date1').text(data.meeting.end_date);
...
$('#print').click(function () {
    $('.print').printThis({
      pageTitle: "Partnership Training",
    });
});
...
google.charts.load('current', {'packages':['corechart']});
      ...
      var data1 = google.visualization.arrayToDataTable([
        ["Element", "LKR", { role: "style" } ],
        ["BEC", <?php echo e($contribution->bec); ?>, "blue"],
        ["Partner", <?php echo e($contribution->partner); ?>, "orange"],
        ["Student", <?php echo e($contribution->student); ?>, "green"],
      ]);
