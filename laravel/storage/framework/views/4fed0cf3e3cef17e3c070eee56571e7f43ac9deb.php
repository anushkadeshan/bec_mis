...
<?php $__env->startSection('title','Institiutes Review |'); ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Review of institutions <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h4>
          </div>
          <div class="col-md-4">
                          ...
                          <table id="example10" class="table row-border table-hover">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Branch</th>
                                        <th>No of Reviewed Instiitutes </th>
...
var dataTable2 = $("#example10").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/skill/institute-review/fetch')); ?>",
   method:"POST",
