...
<?php $__env->startSection('title','Analysis - Soft Skills |'); ?>
<?php $__env->startSection('content'); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-6">
       <span style="float: right" class="text-right"><a href="<?php echo e(URL::to('reports-me/skill/soft-skill')); ?>"><button type="button" class="btn btn-success btn-flat"><i class="fas fa-file-invoice"> View Full Report</i></button></a></span>
       <span style="float: right; margin-right: 5px" class="text-right"><a href="<?php echo e(URL::to('view_soft_youths')); ?>"><button type="button" class="btn btn-info btn-flat"><i class="fas fa-file-invoice"> Youth Progress After Soft Skills</i></button></a></span>
      </div>
    </div>
    <br>
      <div class="row">
          <div class="col-md-4">
            ...
            <div class="card-header">
              Gender wise Soft Skills Youths 
            </div>
            <div class="card-body">
          ...
          <div class="col-md-4">
              <div class="card card-primary">
            <div class="card-header">
              Marital Status wise Soft Skills Youths
            </div>
            <div class="card-body">
      ...
      <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="card-header">
             ...
             <div class="card-body">
               <div id="table_div1" style="max-height: 750px;"></div>
             </div>
        </div>
          </div>
            <div class="col-md-8">
           <div class="card card-primary">
             <div class="card-header">
               DS Division wise Soft Skills Youths
             </div>
             <div class="card-body">
      ...
      <div class="row">
          <div class="col-md-4">
           <div class="card card-primary">
             <div class="card-header">
               Family type of Soft Skills Youths 
             </div>
             <div class="card-body">
...
fetch_data();
 ...
 {
  $.ajax({
   url:"<?php echo e(url('/analysis-soft-fetch')); ?>",
   method:"POST",
