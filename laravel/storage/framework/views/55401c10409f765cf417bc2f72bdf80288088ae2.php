        ...
        <div class="card-body">  
            <table id="example1" class="table row-border table-hover table-responsive" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr class="institute<?php echo e($institute->id); ?>">
                        <td><?php echo e($no++); ?></td>
                        <td><?php echo e($institute->name); ?></td>
                        <td><?php echo e($institute->location); ?></td>
                        <td><?php echo e($institute->address); ?></td>
                        <td><?php echo e($institute->phone); ?> <br> <i class="fas fa-envelope-open-text"></i>&nbsp;<?php echo e($institute->email); ?></td>
                        <td><?php echo e($institute->contact_person); ?></td>
                        <td><?php echo e($institute->is_registerd); ?></td>
                        
                        <td>
                        	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-institute')): ?>
                        	<div class="btn-group">
                                <a href="<?php echo e(URL::to('institute/' . $institute->id . '/view')); ?>">
                                    <button type="button" id="view-institute" data-id="<?php echo e($institute->id); ?>" class="btn btn-block btn-warning btn-flat btn-sm" ><i class="fas fa-eye"></i> </button>
                                </a>
                            
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-institute')): ?>
                            
                                    <button type="submit" id="edit-institute" data-id="<?php echo e($institute->id); ?>" data-name="<?php echo e($institute->name); ?>" data-location="<?php echo e($institute->location); ?>" data-address="<?php echo e($institute->address); ?>" data-contact="<?php echo e($institute->contact_person); ?>" data-email="<?php echo e($institute->email); ?>" data-phone="<?php echo e($institute->phone); ?>" data-is_registerd="<?php echo e($institute->is_registerd); ?>" data-reg_no="<?php echo e($institute->reg_no); ?>" data-type="<?php echo e($institute->type); ?>" class="btn btn-block btn-success btn-flat btn-sm"><i class="fas fa-edit"></i></button>
                        	<?php endif; ?>
                        	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-institute')): ?>
                                ...
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <button type="button" id="delete-institute" data-id="<?php echo e($institute->id); ?>" class="btn btn-block btn-danger btn-flat btn-sm" ><i class="fas fa-trash-alt"></i> </button>
                                </form>
                            </div>
                            <?php endif; ?>
                        </td>
