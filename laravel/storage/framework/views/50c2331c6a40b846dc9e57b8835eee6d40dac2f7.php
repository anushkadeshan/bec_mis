                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" placeholder="" type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row<?php echo e($errors->has('role') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <select id="name" type="text" class="form-control" name="role" value="<?php echo e(old('role')); ?>" required >
