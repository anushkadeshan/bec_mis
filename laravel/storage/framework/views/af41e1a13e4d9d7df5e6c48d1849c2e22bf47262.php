	  ...
	  <div class="col-12">
	    ...
	    <div class="card">
	      <div class="card-header d-flex p-0">
	        <h3 class="card-title p-3">Support for course enrollment & directing to Gvt. Institutes Edit</h3>
                ...
                <div class="row">
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <div class="input-group">
		                        <input data-toggle="tooltip" data-placement="top" title="Search course name and select" type="text" id="course_name" name="res_id" class="form-control" placeholder="Search Name of Course" value="<?php echo e($meeting->course_name); ?>">
                          ...
                          <input type="hidden" id="course_id" name="course_id" value="<?php echo e($meeting->course_id); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
	          	...
	          	<div class="form-group">
						  ...
						  <thead>
						    <tr>
						      ...
						      <th scope="col">Nature of Support</th>
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td><?php echo e($youth->nature_of_support); ?></td>
						      <td><?php echo e($youth->institute_type); ?></td>
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($youth->cid); ?>"  data-nature_of_support="<?php echo e($youth->nature_of_support); ?>" data-institute_type="<?php echo e($youth->institute_type); ?>" data-dropout="<?php echo e($youth->dropout); ?>" data-reoson="<?php echo e($youth->reoson_to_dropout); ?>" id="edit2"><i class="fas fa-edit"></i></button></td>
						    </tr>
					          ...
					          <div class="modal-body">
					              ...
					              <form role="form" method="get" id="myForm1">
					                  ...
					                  <div class="form-group">
					                    ...
					                    <select name="institute_type" class="form-control" id="institute_type1">
									      	<option value="">Select Option</option>
						  ...
						  <tbody>
						    <tr>
						      ...
						      <?php echo e(csrf_field()); ?>
              					...
              					<input type="hidden" id="r_id" name="m_id" value="<?php echo e($meeting->m_id); ?>">
              					<input type="hidden" id="r_id" name="e_date" value="<?php echo e($meeting->end_date); ?>">
						      </form>
						    </tr>
