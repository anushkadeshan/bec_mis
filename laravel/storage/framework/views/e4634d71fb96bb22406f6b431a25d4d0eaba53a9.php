<?php $__env->startSection('title', 'Financial Assistance |'); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                            ...
                                            <div class="card-body">
                                                <table id="youths_table" class="table row-border table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php $__currentLoopData = $youths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $youth): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ?>
                                                                    <select <?php if($youth->end_date > date('Y-m-d') || !is_null($job) || !is_null($vt) || !is_null($soft)|| $youth->cs == 2): ?>
                                                                        disabled
                                                        <?php endif; ?>
                                                        ...
                                                        <option <?php if(!is_null($vt) || $youth->cs == 2): ?>  selected
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            Financially supported youth <a href="<?php echo e(url('financial-youth')); ?>"><span
...
<script>
    ...
    $(document).ready(function() {
        ...
        function fetch_data(dateStart = '', dateEnd = '', branch = '' /* ,course='',institute=''*/ ) {
            $.ajax({
                url: "<?php echo e(url('reports-me/skill/financial/fetch')); ?>",
                method: "POST",
                data: {
                    dateStart: dateStart,
                    dateEnd: dateEnd,
    ...
    $('body').on('click', '.btn_view', function() {
        ...
        $.get("<?php echo e(url('reports-me/skill/financial')); ?>" + '/' + meeting_id + '/view', function(data) {
