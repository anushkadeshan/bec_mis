	    ...
	    <div class="card">
	      ...
	      <div class="card-body">
	        ...
	        <div class="tab-content">
	          		...
	          		<div class="col-md-4">
	          			<div class="form-group">
						    ...
						    <select name="district" id="district" class="form-control" data-dependent="dsd">
								<option value=""><?php echo e($placements->district); ?></option>
    					   </select>
						</div>
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
							...
							<option value=""><?php echo e($placements->dsd); ?></option>	
    					   </select>
						</div>
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
						    ...
						    <select name="dm_name" id="dm_name" class="form-control">
								<option value=""><?php echo e($placements->dm_name); ?></option>
    					   </select>
						</div>
	          		</div>
	          	</div>
	            ...
	            <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="program_date" id="program_date" class="form-control" value="<?php echo e($placements->program_date); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <div class="input-group">                       
		                        <input data-toggle="tooltip" data-placement="top" title="Search Employer name" type="text" id="employer" name="employer" class="form-control" placeholder="Search Employer Name" value="<?php echo e($placements->employer_name); ?>">
                      	...
                      	<input type="hidden" id="employer_id" name="employer_id" class="form-control" value="<?php echo e($placements->employer_id); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <div class="input-group">                       
		                        <input data-toggle="tooltip" data-placement="top" title="Search youth name or NIC select" type="text" id="youth" name="youth" class="form-control" placeholder="Search Name or NIC of youth" value="<?php echo e($placements->youth_name); ?>">
                      	...
                      	<input type="hidden" id="youth_id" name="youth_id" class="form-control" value="<?php echo e($placements->youth_id); ?>">
						</div>
	            	</div>
	            </div>	
	            <div class="row">
	          		<div class="col-md-4">
	          			<div class="form-group">
						    ...
						    <input type="text" name="type_of_support" class="form-control position-list" value="<?php echo e($placements->type_of_support); ?>">
						</div>
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
						    <label for="dsd">10. Vacancy Placed (Position)</label>
						    <input type="text" name="vacancy" class="form-control position-list" value="<?php echo e($placements->vacancy); ?>">
						</div>
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
						    <label for="dm_name">11. Salary</label>
						    <input type="text" name="salary" class="form-control position-list" value="<?php echo e($placements->salary); ?>">
						</div>
	          		</div>
	          	</div>
	          ...
	          <!-- /.tab-pane -->
	         	<input type="hidden" id="r_id" name="m_id" value="<?php echo e($placements->m_id); ?>">
