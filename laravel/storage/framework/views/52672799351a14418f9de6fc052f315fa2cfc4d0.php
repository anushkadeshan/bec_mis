      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h3>Training on Career counselling for GND level officers <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h3>
          </div>
          <div class="col-md-4">
...
var dataTable = $("#example").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/cg/cg-training/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/cg-training')); ?>" +'/' + meeting_id +'/view', function (data) {
