...
<?php $__env->startSection('title','Analysis - Course Supports |'); ?>
<?php $__env->startSection('content'); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-2">
        <div class="color-palette-set">
          <div class="bg-success disabled color-palette"><span> &nbsp; No of Youths directed</div>
          <div class="bg-success color-palette">&nbsp; <span id="count-youths"></span></div>
        </div>
      </div>
       <div class="col-sm-4 col-md-2">
        <div class="color-palette-set">
          <div class="bg-warning disabled color-palette"><span> &nbsp; No of directed Courses</div>
          <div class="bg-warning color-palette">&nbsp; <span id="count-courses"></span></div>
        </div>
      </div><div class="col-sm-4 col-md-2">
        <div class="color-palette-set">
          <div class="bg-primary disabled color-palette"><span> &nbsp; No of directed Institutes</div>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-6">
       <span style="float: right" class="text-right"><a href="<?php echo e(URL::to('reports-me/skill/gvt-support')); ?>"><button type="button" class="btn btn-success btn-flat"><i class="fas fa-file-invoice"> View Full Report</i></button></a></span>

       <span style="float: right; margin-right: 5px" class="text-right"><a href="<?php echo e(URL::to('view_gvt_youths')); ?>"><button type="button" class="btn btn-info btn-flat"><i class="fas fa-file-invoice"> Youth Progress After Course Finished<</i></button></a></span>
      </div>
    </div>
    <br>
      <div class="row">
          <div class="col-md-4">
            ...
            <div class="card-header">
              Gender wise Supports to Gvt Courses 
            </div>
            <div class="card-body">
          ...
          <div class="col-md-4">
              <div class="card card-primary">
            <div class="card-header">
              Marital Status wise Supports to Gvt Courses
            </div>
            <div class="card-body">
          ...
          <div class="col-md-4">
              <div class="card card-primary">
            <div class="card-header">
              Race wise Supports to Gvt Courses
            </div>
            <div class="card-body">
      ...
      <div class="row">
          <div class="col-md-4">
           <div class="card card-primary">
             <div class="card-header">
               Family type of Supported Youths <span class="badge badge-info text-right"> </span>
             </div>
             <div class="card-body">
          ...
          <div class="col-md-8">
           <div class="card card-primary">
             <div class="card-header">
               DS Division wise Supported Youths
             </div>
             <div class="card-body">
               <div id="barchart_material" style=" max-height: 750px; min-height: 400px"></div>
             </div>
           </div>
          </div>
      </div>
...
fetch_data();
 ...
 {
  $.ajax({
   url:"<?php echo e(url('/analysis-gvt-fetch')); ?>",
   method:"POST",
