	            	...
	            	<div class="col-md-8">
	            		<div class="form-group">
						    ...
						    <select name="title_of_action" id="title_of_action" class="form-control">
								...
								<option <?php if($activity->activity=='Stake holder meeting in DSD level to aware BECs new strategic plan / directions'): ?> selected <?php endif; ?> value="<?php echo e($activity->activity); ?>"><?php echo e($activity->activity); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="activity_code" id="activity_code" class="form-control">
								<option value="">Select Option</option>
								<?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($activity->code=='2.1.1'): ?> selected <?php endif; ?> value="<?php echo e($activity->code); ?>"><?php echo e($activity->code); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
