	          		...
	          		<div class="col-md-3">
	          			<div class="form-group">
						    ...
						    <select name="district" id="district" class="form-control" data-dependent="dsd">
								<option value=""><?php echo e($meeting->district); ?></option>
    					   </select>
						</div>
	          		</div>
	          		<div class="col-md-3">
	          		...
	          		<div class="col-md-3">
	          			<div class="form-group">
						    ...
						    <select name="dm_name" id="dm_name" class="form-control">
								<option value=""><?php echo e($meeting->dm_name); ?></option>
    					   </select>
						</div>
	          		</div>
	          	</div>
	            <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="date" name="program_date" id="date" class="form-control" value="<?php echo e($meeting->program_date); ?>">
						</div>
	            	</div>
                ...
                <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="text" name="responding_officer_name" id="responding_officer_name" class="form-control"  value="<?php echo e($meeting->responding_officer_name); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    <label for="dm_name">9. Designation</label>
						    <input type="text" name="responding_officer_des" id="responding_officer_des" class="form-control" value="<?php echo e($meeting->responding_officer_des); ?>">
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    <label for="dm_name">10. Contact details</label>
						    <input type="text" name="responding_officer_contacts" id="responding_officer_contacts" class="form-control" value="<?php echo e($meeting->responding_officer_contacts); ?>">
						</div>
	            	</div>
                ...
                <div class="row">
	            	<div class="col-md-9">
	            		<div class="form-group">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->type_of_services); ?></textarea>
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <select name="records" id="records" class="form-control">
								...
								<option <?php if($meeting->records=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
								<option <?php if($meeting->records=="No"): ?> selected <?php endif; ?> value="No">No</option>
								<option <?php if($meeting->records=="Incomplete"): ?> selected <?php endif; ?> value="Incomplete">Incomplete</option>
	            ...
	            <div class="row">
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <input type="number" name="male_18_24" id="male_18_24" class="form-control"  value="<?php echo e($meeting->male_18_24); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">14. Total Male (25-30)</label>
						    <input type="number" name="male_25_30" id="male_25_30" class="form-control" value="<?php echo e($meeting->male_25_30); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">15. Total Male (>30)</label>
						    <input type="number" name="male_30" id="male_30" class="form-control" value="<?php echo e($meeting->male_30); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">15. No of PWD Male</label>
						    <input type="number" name="pwd_male" id="pwd_male" class="form-control" value="<?php echo e($meeting->pwd_male); ?>">
						</div>
	            	</div>
	            </div>	
	            <div class="row">
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <input type="number" name="female_18_24" id="female_18_24" class="form-control" value="<?php echo e($meeting->female_18_24); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">17. Total Female (25-30)</label>
						    <input type="number" name="female_25_30" id="female_25_30" class="form-control" value="<?php echo e($meeting->female_25_30); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">18. Total Female (>30)</label>
						    <input type="number" name="female_30" id="female_30" class="form-control" value="<?php echo e($meeting->female_30); ?>">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">19. No of PWD Female</label>
						    <input type="number" name="pwd_female" id="pwd_female" class="form-control" value="<?php echo e($meeting->pwd_female); ?>">
						</div>
	            	</div>
	            </div>
	            <div style="width: 100%; height: 20px; border-bottom: 1px solid blue; text-align: center;padding-bottom: 10px">
	           ...
	           <div class="row">
	           	  <div class="form-group">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <td><?php echo e($service->male); ?></td>
						      <td><?php echo e($service->female); ?></td>
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($service->id); ?>" data-male="<?php echo e($service->male); ?>" data-female="<?php echo e($service->female); ?>" id="edit2"><i class="fa fa-edit"></i></button></td>
						    </tr>
	           ...
	           <div style="width: 100%; height: 20px; border-bottom: 1px solid blue; text-align: center;padding-bottom: 10px">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="unit_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->unit_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->unit_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="space_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->space_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->space_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="stationary_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->stationary_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->stationary_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
	            			...
	            			<select name="chairs_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->chairs_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->chairs_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
	            			...
	            			<select name="tables_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->tables_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->tables_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
	            			...
	            			<select name="cupboards_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->cupboards_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->cupboards_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
	            			...
	            			<select name="stationary_items_available" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->stationary_items_available=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->stationary_items_available=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->lack_of_items); ?></textarea>
						</div>
	            	</div>	            	
	            </div>
	            <div class="row">
	            	<div class="col-md-6">
	            		<div class="form-group">
						    ...
						    <input type="number" name="staff" id="staff" class="form-control" value="<?php echo e($meeting->staff); ?>">
	            	...
	            	<div class="col-md-6">
	            		<div class="form-group">
	            			...
	            			<select name="sufficient_staff" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->sufficient_staff=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->sufficient_staff=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->additional_staff); ?></textarea>
						</div>
	            	</div>	            	
	            </div>
                ...
                <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="vt_database" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->vt_database=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->vt_database=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="update_vt" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->update_vt=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->update_vt=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<input type="date" name="last_updated_vt" class="form-control" value="<?php echo e($meeting->last_updated_vt); ?>">
	            		</div>
	            	</div>
	            </div>
	            <div style="width: 100%; height: 20px; border-bottom: 1px solid blue; text-align: center;padding-bottom: 10px">
                ...
                <div class="row">
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="job_database" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->job_database=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->job_database=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			...
	            			<select name="update_job" class="form-control">
	            				<option value="">Select Option</option>
	            				<option <?php if($meeting->update_job=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	            				<option <?php if($meeting->update_job=="No"): ?> selected <?php endif; ?> value="No">No</option>
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
	            			<label for="">If not when was it last updated?</label>
	            			<input type="date" name="last_updated_job" class="form-control" value="<?php echo e($meeting->last_updated_job); ?>">
	            		</div>
	            	</div>
	            ...
	            <div class="row">
		            	<div class="col-md-12">
		            		<div class="form-group">
	                          ...
	                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->reasons_to_not_update); ?></textarea>
							</div>
		            	</div>	            	
	            	</div>
	            	<div class="row">
		            	<div class="col-md-12">
		            		<div class="form-group">
	                          ...
	                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> <?php echo e($meeting->gaps); ?></textarea>
							</div>
		            	</div>	            	
	            	</div>
