        ...
        <div class="card-body">  
            <table id="example1" class="table row-border table-hover">
                ...
                <tbody>
                    ...
                    <tr class="task<?php echo e($task->id); ?>">
                        <td><?php echo e($no++); ?></td>
                        <td><?php echo e($task->task); ?></td>
                        <td><?php echo e($task->due_date); ?></td>
                        <td><?php echo e($task->severity); ?></td>
                        ...
                        <td>
                            <div class="btn-group">
                            	<?php echo e(csrf_field()); ?>
                                    ...
                                    <button type="button" id="edit-task" data-id="<?php echo e($task->id); ?>" data-task="<?php echo e($task->task); ?>" data-due_date="<?php echo e($task->due_date); ?>" data-severity="<?php echo e($task->severity); ?>" class="btn btn-success btn-flat btn-sm"><i class="fas fa-edit"></i></button>
                                    <button type="button" id="delete-task" data-id="<?php echo e($task->id); ?>" class="btn btn-danger btn-flat btn-sm"><i class="fas fa-trash"></i></button>
                            </div>
                        </td>
                    </tr>
