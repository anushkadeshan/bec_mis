...
<?php $__env->startSection('title','Stake Holder Meetings |'); ?>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <h3>2.1.1 Stake Holder Meeting <small class="badge badge-success"> <?php echo e(count($meetings)); ?></small></h3>
          </div>
          <div class="col-md-6">
                    ...
                    <div class="row">
                    	<div class="col-md-6">
                              ...
                              <li class="list-group-item border-0"><strong>DSDs : </strong><span id="dsd"></span></li>
          									  <li class="list-group-item border-0"><strong>GND : </strong><span id="gnd"></span></li>
...
var dataTable2 = $("#example3").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(route('reports-me/cg/stake-holder-meeting/fetch')); ?>",
   method:"POST",
  ...
  dataTable.clear().draw();
   ...
   dataTable2.clear().draw();
    ...
    dataTable2.row.add([count2++, value2.name, value2.total, value2.total_male, value2.total_female, value2.program_cost.toLocaleString()]).draw();
    });

  $.each(data.data, function(index, value) {
    console.log(value);
    // use data table row.add, then .draw for table refresh
    dataTable.row.add([count++, value.program_date, value.total_male, value.total_female,value.venue,value.program_cost, value.name,'<div class="btn-group"><button type="button" name="view" data-id="'+value.m_id+'" class="btn btn-warning btn-flat btn-sm btn_view"><i class="fa fa-eye"></i></button><a href="<?php echo e(url('reports-me/stake')); ?>/'+value.m_id+'/edit"><button type="button" name="view" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></button></a></div>']).draw();

     var total_male = value.total_male;
     var total_female = value.total_female;
     var total_cost = value.program_cost;
     if ($.isNumeric(total_male,total_female,program_cost)) {
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/stakeHolder')); ?>" +'/' + meeting_id +'/view', function (data) {
          ...
          $('#decisions').html(data.meeting.decisions);
          ...
          var url = SITE_URL+ '/download/stake/'+file_id;

          $("#link").attr("href",url);

          var id = data.meeting.m_id;
          var url1 = SITE_URL+ '/download/stake/photos/'+id;
...
$('#print').click(function () {
    $('.print').printThis({
    	pageTitle: "Stake Holder Meeting",
    });
});
...
google.charts.load('current', {'packages':['corechart']});
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['2018',  <?php if($participants2018->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2018->total_male); ?> <?php endif; ?> , <?php if($participants2018->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2018->total_female); ?><?php endif; ?>],
          ['2019',  <?php if($participants2019->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2019->total_male); ?> <?php endif; ?> , <?php if($participants2019->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2019->total_female); ?><?php endif; ?>],
          ['2020',  <?php if($participants2020->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2020->total_male); ?> <?php endif; ?> , <?php if($participants2020->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2020->total_female); ?><?php endif; ?>],
          ['2021',  <?php if($participants2021->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2021->total_male); ?> <?php endif; ?> , <?php if($participants2021->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($participants2021->total_female); ?><?php endif; ?>],
          
        ]);

        var options = {
          title: 'Stake Holder Meeting Participants',
          curveType: 'function',
