...
<?php $__env->startSection('title','Analysis - Financial Assistance |'); ?>
<?php $__env->startSection('content'); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-6">
       <span style="float: right" class="text-right"><a href="<?php echo e(URL::to('reports-me/skill/financial')); ?>"><button type="button" class="btn btn-success btn-flat"><i class="fas fa-file-invoice"> View Full Report</i></button></a></span>
       <span style="float: right; margin-right: 5px" class="text-right"><a href="<?php echo e(URL::to('financial-youth')); ?>"><button type="button" class="btn btn-info btn-flat"><i class="fas fa-file-invoice"> Youth Progress After Course finished</i></button></a></span>
      </div>
    </div>
    <br>
      <div class="row">
      ...
      <div class="row">
          <div class="col-md-4">
           <div class="card card-primary">
             <div class="card-header">
               Family type of Finacially Supported <span class="badge badge-info text-right"> </span>
             </div>
             <div class="card-body">
...
fetch_data();
 ...
 {
  $.ajax({
   url:"<?php echo e(url('/analysis-financial-fetch')); ?>",
   method:"POST",
