                    ...
                    <div  class="row">
                      ...
                      <div  class="col-md-7">
                        <div class="card card-success">
                          <div  class="card-header">
                            Youth Participation (all time) <a href="<?php echo e(Route('view_cg_youths')); ?>"><span  class="badge badge-warning float-right" id="row_count">View Youth Report</span></a>
                          </div>
                          <div  class="card-body">
...
var dataTable3 = $("#example10").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/cg/cg/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/cg')); ?>" +'/' + meeting_id +'/view', function (data) {
