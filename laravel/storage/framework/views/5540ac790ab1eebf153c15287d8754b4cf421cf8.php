...
<?php $__env->startSection('title','Add Youth |'); ?>
<?php $__env->startSection('content'); ?>
<div class="container-fluid">
	<br>
  <?php if($cg_youths->target > $youths): ?>
  <div class="alert alert-warning alert-dismissible">
      <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>

        <h5><i class="fas fa-exclamation-triangle"></i> Alert!</h5>
        You have to add more <strong><?php echo e($cg_youths->target - $youths); ?> </strong> Base Line Applications against your Career Guidance Progress <strong>(<?php echo e($cg_youths->target); ?> )</strong> in 2018 and 2019 years. Please Add rest of Baseline applications ASAP.
  </div>
  <?php endif; ?>
              ...
              <div class="card-body">
                  	...
                  	<form id="youth" name="youth">
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" id="branch_id" name="branch_id">
                                ...
                                <option <?php if(Auth::user()->branch == $branch->id): ?> selected <?php endif; ?>  value="<?php echo e($branch->id); ?>"><?php echo e($branch->name); ?></option>
                ...
                <div class="tab-pane" id="tab_6">
                  ...
                  <center>
                    ...
                    <a href="<?php echo e(Route('youth/add')); ?>" title=""><button type="button" class="btn btn-success btn-flat">Add Another</button></a>
                  </center>
                </div> 
                <!-- /.tab-content -->
              </div><!-- /.card-body -->
