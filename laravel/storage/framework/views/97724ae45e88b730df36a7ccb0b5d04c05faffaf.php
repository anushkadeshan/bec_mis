...
<?php $__env->startSection('title','Kick Offs |'); ?>
...
var dataTable3 = $("#example4").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/cg/kick-off-meeting/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/kick-off')); ?>" +'/' + meeting_id +'/view', function (data) {
...
$('body').on('click', '.btn_view1', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/hhs')); ?>" +'/' + meeting_id +'/view', function (data) {
...
google.charts.load('current', {'packages':['corechart']});
      ...
      function drawChart1() {
        var data1 = google.visualization.arrayToDataTable([
          ['Year', 'Total Male', 'Total Female','PWD Male','PWD Female'],
          ['2018',  <?php if($hhs2018->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2018->total_male); ?> <?php endif; ?> , <?php if($hhs2018->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2018->total_female); ?><?php endif; ?>, <?php if($hhs2018->pwd_male==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2018->pwd_male); ?><?php endif; ?>,<?php if($hhs2018->pwd_female==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2018->pwd_female); ?><?php endif; ?>],
          ['2019',  <?php if($hhs2019->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2019->total_male); ?> <?php endif; ?> , <?php if($hhs2019->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2019->total_female); ?><?php endif; ?>, <?php if($hhs2019->pwd_male==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2019->pwd_male); ?><?php endif; ?>,<?php if($hhs2019->pwd_female==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2019->pwd_female); ?><?php endif; ?>],
          ['2020',  <?php if($hhs2020->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2020->total_male); ?> <?php endif; ?> , <?php if($hhs2020->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2020->total_female); ?><?php endif; ?>, <?php if($hhs2020->pwd_male==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2020->pwd_male); ?><?php endif; ?>,<?php if($hhs2020->pwd_female==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2020->pwd_female); ?><?php endif; ?>],
          ['2021',  <?php if($hhs2021->total_male==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2021->total_male); ?> <?php endif; ?> , <?php if($hhs2021->total_female==null): ?> <?php echo e(0); ?> <?php else: ?> <?php echo e($hhs2021->total_female); ?><?php endif; ?>, <?php if($hhs2021->pwd_male==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2021->pwd_male); ?><?php endif; ?>,<?php if($hhs2021->pwd_female==null): ?> <?php echo e(0); ?> <?php else: ?><?php echo e($hhs2021->pwd_female); ?><?php endif; ?>],
