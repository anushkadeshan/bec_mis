  ...
  <div class="row">
                            ...
                            <div class="form-group">
                              <label for="employer">Employer</label>
                                  <select name="employer" id="employer" class="form-control">
                                    ...
                                    <option value="<?php echo e($employer->name); ?>"><?php echo e($employer->name); ?></option>
    ...
    <div class="col-md-9">
      <div class="card card-success card-outline">
                ...
                <tbody>
                <?php $__currentLoopData = $vacancies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vacancies): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($vacancies->title); ?></td>
                    <td><?php echo e($vacancies->description); ?></td>
                    <td><?php echo e($vacancies->job_type); ?></td>
                    <td><?php echo e($vacancies->business_function); ?></td>
                    <td><?php echo e($vacancies->location); ?></td>
                    <td><?php echo e($vacancies->min_qualification); ?></td>                                                          
                    <td><?php echo e($vacancies->specializaion); ?></td>                                                          
                    <td><?php echo e($vacancies->employer->name); ?></td>                                                          
                  </tr>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                </tbody>
            </table>      
