      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <h3>1.1.1 Attending BMIC regional meeting <small class="badge badge-danger"> <?php echo e(count($meetings)); ?></small></h3>
          </div>
          <div class="col-md-6">
...
$(document).ready(function() {
 ...
 {
  $.ajax({
   url:"<?php echo e(route('reports-me/education/regional-meeting/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(route('reports-me/education/regional-meeting')); ?>" +'/' + meeting_id +'/view', function (data) {
