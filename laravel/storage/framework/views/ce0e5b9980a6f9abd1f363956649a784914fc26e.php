	            ...
	            <div class="row">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="nymber" name="cost" id="cost" class="form-control" value="<?php echo e($meeting->cost); ?>">
						</div>
	            	</div>
	            </div>
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <select name="institutional_review" id="institutional_review" class="form-control">
								...
								<option <?php if($meeting->institutional_review=="Yes"): ?> selected <?php endif; ?> <?php if($meeting->institutional_review=="Yes"): ?> selected <?php endif; ?> value="Yes">Yes</option>
	          	...
	          	<div class="form-group">
						  ...
						  <tbody>
						    ...
						    <tr>
						      ...
						      <td style="text-align: center"><?php echo e($youth->approved_amount); ?></td>
						      <td><?php echo e($youth->installments); ?></td>
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="<?php echo e($youth->f_id); ?>" data-approved_amount="<?php echo e($youth->approved_amount); ?>" data-installments="<?php echo e($youth->installments); ?>" data-dropout="<?php echo e($youth->dropout); ?>" data-reoson="<?php echo e($youth->reoson_to_dropout); ?>" id="edit2"><i class="fas fa-edit"></i></button></td>
						    </tr>
