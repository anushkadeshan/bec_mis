...
<?php $__env->startSection('title','Support to CIC Units |'); ?>
...
var dataTable = $("#example").DataTable({
 ...
 {
  $.ajax({
   url:"<?php echo e(Route('reports-me/cg/pes-support/fetch')); ?>",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/pes-support')); ?>" +'/' + meeting_id +'/view', function (data) {
...
$('body').on('click', '#review_id', function () {
      ...
      $.get("<?php echo e(url('reports-me/cg/pes')); ?>" +'/' + meeting_id +'/view', function (data) {
...
google.charts.load('current', {'packages':['corechart']});
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ...
          ['2018',  <?php echo e($participants2018); ?>],
          ['2019',  <?php echo e($participants2019); ?>],
          ['2020',  <?php echo e($participants2020); ?>],
          ['2021',  <?php echo e($participants2021); ?>],
