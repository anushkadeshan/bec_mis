...
<?php $__env->startSection('title','Finacial Assistance |'); ?>
	  ...
	  <div class="col-12">
	    ...
	    <div class="card">
	      <div class="card-header d-flex p-0">
	        <h3 class="card-title p-3">Financial assistance to follow VT/Professional courses  </h3>
	            	...
	            	<div class="col-md-8">
	            		...
	            		<div class="form-group">
						    ...
						    <select name="title_of_action" id="title_of_action" class="form-control">
								...
								<option <?php if($activity->activity=="Financial assistance for deserving youth to follow demand driven VT/Professional courses"): ?> selected <?php endif; ?> value="<?php echo e($activity->activity); ?>"><?php echo e($activity->activity); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="activity_code" id="activity_code" class="form-control">
								<option value="">Select Option</option>
								<?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<option <?php if($activity->code=="3.1.4"): ?> selected <?php endif; ?> value="<?php echo e($activity->code); ?>"><?php echo e($activity->code); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    					   </select>
						</div>
	            	</div>
	            ...
	            <div class="row">
	            	...
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <input type="nymber" name="cost" id="cost" class="form-control">
						</div>
	            	</div>
	            </div>
...
$(document).ready(function(){
     $("#course_support").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/skill/add-finacial-support',   
