...
$(document).ready(function(){
     $("#kick").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activities/career-guidance/kick-off-add',   
            ...
            success: function(data) {
              ...
              toastr.success('Succesfully Add Kick off events Details ! ', 'Congratulations', {timeOut: 5000});
			  $("#kick")[0].reset();
