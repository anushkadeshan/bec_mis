	            ...
	            <div class="row">
	            	...
	            	<div class="col-md-3">
	            		<div class="form-group">
						    ...
						    <input type="number" name="program_cost" id="program_cost" class="form-control" value="{{$meeting->program_cost}}">
						</div>
	            	</div>
	            </div>
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"> {{$meeting->decisions}}</textarea>
						</div>
	            	</div>	            	
	            </div>
	            {{csrf_field()}}
	          ...
	          <div class="tab-pane" id="tab_2">
	          	<div class="form-group">
						  ...
						  <tbody>
						    ...
						    <tr>
						      <td>{{$no++}}</td>
						      <th><input type="text" name="name[]" class="form-control name-list" value="{{$participant->name}}"></th>
						      <td><input type="text" name="gender[]" class="form-control position-list" value="{{$participant->gender}}"></td>
						      <td><input type="text" name="designation[]" class="form-control branch-list" value="{{$participant->designation}}"></td>
						      <td><input type="text" name="institute[]" class="form-control branch-list" value="{{$participant->institute}}"></td>
						      <td><input type="text" name="phone[]" class="form-control branch-list" value="{{$participant->phone}}"></td>
						      <td><button type="button" class="btn btn-success btn-flat btn-sm" data-id="{{$participant->id}}" data-name="{{$participant->name}}" data-gender="{{$participant->gender}}" data-designation="{{$participant->designation}}" data-institute="{{$participant->institute}}" data-Phone="{{$participant->phone}}" id="edit2"><i class="fa fa-edit"></i></button></td>
						    </tr>
						    @endforeach
						  </tbody>
						</table>
