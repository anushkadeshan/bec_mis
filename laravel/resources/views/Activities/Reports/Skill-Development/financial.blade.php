                                            ...
                                            <div class="card-body">
                                                <table id="youths_table" class="table row-border table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($youths as $youth)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @endphp
                                                                    <select @if ($youth->end_date > date('Y-m-d') || !is_null($job) || !is_null($vt))
                                                                        disabled
                                                        @endif
                                                        ...
                                                        <option @if ($youth->cs == 7) selected
                                                            @endif value="7">Permanatly Quit from Career
                                                            Path</option>
                                                        </select>
