            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-md-8">
                        ...
                        <h4>Financial assistance to follow VT/Professional courses <small class="badge badge-success">
                                {{ count($meetings) }}</small></h4>
                    </div>
                    <div class="col-md-4">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab_1">
                                        <div>
                                            ...
                                            <a class="btn btn-app zoom">
                                                <span class="badge bg-warning" id="">{{ $ongoing }}</span>
                                    ...
                                    @endcan
                                        ...
                                        <div class="card card-success">
                                            <div class="card-header">
                                                Current Status of Financial Assisted VT/Prof Youth
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($youths as $youth)
                                                            <tr>
                                                                ...
                                                                <td><a
                                                                        href="{{ URL::to('youth/' . $youth->youth_id . '/view') }}">{{ $youth->youth_name }}</a>
                                                                </td>
                                                                <td>{{ $youth->phone }}</td>
                                                                <td>
                                                                    @switch($youth->dropout)
                                                                        @case(1)
                                                                        <small
                                                                            class="badge badge-danger">{{ 'Dropout' }}</small>
                                                                        @break
                                                                        @case(0)
                                                                        @if ($youth->end_date < date('Y-m-d'))
                                                                            <small
                                                                                class="badge badge-warning">{{ 'Finished' }}</small>
                                                                        @else
                                                                            <small
                                                                                class="badge badge-success">{{ 'Ongoing' }}</small>
                                                                        @endif
                                                                        @break
                                                                        @default
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @endphp
                                                                    <select @if ($youth->end_date > date('Y-m-d') || !is_null($job) || !is_null($vt) || !is_null($soft)|| $youth->cs == 2)
                                                                        disabled
                                                        @endif
                                                        name="current_status" id="current_status" class="form-control"
                                                        onchange="updateStatus(this.value,{{ $youth->youth_id }})">
                                                        <option @if ($youth->cs == 5) selected
                                                            @endif value="5">No Job</option>
                                                        <option @if ($youth->end_date > date('Y-m-d')) selected
                                                            @endif value="1">Still Following Course
                                                        </option>
                                                        <option @if (!is_null($vt) || $youth->cs == 2)  selected
                                                            @endif value="2">Following Course-BEC
                                                            Supported</option>
                                                        <option @if ($youth->cs == 3) selected
                                                            @endif value="3">Following Course-BEC Not
                                                            Supported</option>
                                                        <option @if (!is_null($soft)) selected
                                                            @endif value="7">Following a Soft Skill Course
                                                            </option>
                                                        <option @if (!is_null($job)) selected
                                                            @endif value="4">On the Job</option>
                                                        <option @if ($youth->cs == 6) selected
                                                            @endif value="6">Not Contactable</option>
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            Financially supported youth <a href="{{ url('financial-youth') }}"><span
                                            ...
                                            <div class="card card-success card-outline">
                                                ...
                                                <div class="card-body">
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item border-0"><strong>Cost :
                                                            </strong><span id="cost"></span></li>
                                            ...
                                            <div class="card card-success card-outline">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <button type="button hidden-print" id="print"
                                                        ...
                                                        Print</button>
                                                    <button type="button" id="review_id" data-id="" name="file_name"
                                                        class="btn btn-primary btn-flat" data-id=""
                                                        data-attendance=""><i class="fas fa-download"></i> Review
                                                        Report</button>
                                                    <a id="link4" href="" target="_blank"> <button type="button"
                                                            id="download_a" name="file_name"
                                                            class="btn btn-warning btn-flat" data-id=""
                                                            data-attendance=""><i class="fas fa-download"></i> MOU
                                                            Report</button></a>
...
<script>
    ...
    function updateStatus(value, id) {
        if (value == 3) {
            ...
            $.ajax({
                type: 'GET',
                url: SITE_URL + '/change-vt-status/' + value + '/' + id,
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data.summary, function(index, value2) {
                        ...
                        dataTable2.row.add([count2++, value2.name, value2.progs, value2
                            .male, value2.female, value2.male + value2.female,
                            value2.dropout, value2.status, parseFloat(value2
                    ...
                    $.each(data.data, function(index, value) {
                        ...
                        dataTable.row.add([count++, value.meeting_date, value.total_male,
                            ...
                            '<div class="btn-group"><button type="button" name="view" data-id="' +value.m_id + '" class="btn btn-warning btn-flat btn-sm btn_view"><i class="fa fa-eye"></i></button><a href="{{ url('reports-me/financial') }}/'+value.m_id +'/edit"><button type="button" name="view" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></button></a></div>'
                        ]).draw();
    ...
    $('body').on('click', '.btn_view', function() {
        ...
        $.get("{{ url('reports-me/skill/financial') }}" + '/' + meeting_id + '/view', function(data) {
            ...
            var url4 = SITE_URL + '/download/financial/' + mou;
            ...
            for (var count = 0; count < data.youths.length; count++) {
                ...
                output1 += '<td><a target="_blank" href="' + SITE_URL + '/youth/' + data.youths[count]
                    .youth_id + '/view">' + data.youths[count].name + '</a></td>';
                output1 += '<td>' + data.youths[count].approved_amount + '</td>';
                output1 += '<td>' + data.youths[count].installments + '</td></tr>';
            }
    ...
    $('body').on('click', '#review_id', function() {
        ...
        $.get("{{ url('reports-me/skill/institute-review') }}" + '/' + meeting_id + '/view', function(data) {
            ...
            for (var count = 0; count < data.courses.length; count++) {
                ...
                output1 += '<tr>';
                output1 += '<td>' + (count + 1) + '</td>';
                output1 += '<td><a target="_blank" href="' + SITE_URL + '/courses/' + data.courses[
                    count].course_id + '/view">' + data.courses[count].name + '</a></td>';
    ...
    $(document).ready(function() {
        $("#following_course").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: SITE_URL + '/vt-status/course-follow',
