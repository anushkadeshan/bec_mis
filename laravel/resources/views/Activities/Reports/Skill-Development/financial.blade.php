      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Financial assistance to follow VT/Professional courses <small class="badge badge-success"> {{count($meetings)}}</small></h4>
          </div>
          <div class="col-md-4">
                  ...
                  <div class="tab-pane print" id="tab_3">
                    <div class="row">
                        ...
                        <div class="card card-success card-outline">
                          <div class="card-header">
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item border-0"><strong>Cost : </strong><span id="cost"></span></li>
                      ...
                      <div class="col-md-6">
                       ...
                       <button type="button" id="review_id" data-id="" name="file_name" class="btn btn-primary btn-flat" data-id="" data-attendance=""><i class="fas fa-download"></i> Review Report</button>
