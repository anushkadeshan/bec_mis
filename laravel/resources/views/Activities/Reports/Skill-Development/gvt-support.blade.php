...
@section('title', 'GVT Course Support |')
@section('content')
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                                        ...
                                                        @foreach ($youths as $youth)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    ->where('youth_id',$youth->youth_id)->first();
                                                                    @endphp
                                                                    <select @if ($youth->end_date > date('Y-m-d') || !is_null($job) || !is_null($vt) || !is_null($soft))
                                                                        disabled
                                                        @endif
                                    ...
                                    <div class="card card-success">
                                        <div class="card-header">
                                            Enrolled Youths <a href="{{ Route('view_gvt_youths') }}"><span
                ...
                success: function(data) {
                    ...
                    $.each(data.data, function(index, value) {
                        ...
                        dataTable.row.add([count++, value.meeting_date, value.total_male,
                            ...
                            '<div class="btn-group"><button type="button" name="view" data-id="' +value.m_id + '" class="btn btn-warning btn-flat btn-sm btn_view"><i class="fa fa-eye"></i></button><a href="{{ url('reports-me/gvt-support') }}/'+value.m_id +'/edit"><button type="button" name="view" class="btn btn-success btn-flat btn-sm"><i class="fa fa-edit"></i></button></a></div>'
                        ]).draw();
