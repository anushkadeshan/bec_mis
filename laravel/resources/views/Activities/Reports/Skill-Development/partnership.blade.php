...
@section('title','Partnership Trainings |')
@section('content')
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-8">
            ...
            <h4>Partnership Training <small class="badge badge-success"> {{count($meetings)}}</small></h4>
          </div>
          <div class="col-md-4">
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("{{ url('reports-me/skill/partnership') }}" +'/' + meeting_id +'/view', function (data) {
...
google.charts.load('current', {'packages':['corechart']});
      ...
      var data1 = google.visualization.arrayToDataTable([
        ...
        ["BEC", {{$contribution->bec}}, "blue"],
        ["Partner", {{$contribution->partner}}, "orange"],
        ["Student", {{$contribution->student}}, "green"],
      ]);
