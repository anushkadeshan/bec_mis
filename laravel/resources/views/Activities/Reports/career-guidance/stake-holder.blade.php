...
@section('title','Stake Holder Meetings |')
@section('content')
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-6">
            ...
            <h3>2.1.1 Stake Holder Meeting <small class="badge badge-success"> {{count($meetings)}}</small></h3>
          </div>
          <div class="col-md-6">
...
var dataTable2 = $("#example3").DataTable({
 ...
 {
  $.ajax({
   url:"{{ route('reports-me/cg/stake-holder-meeting/fetch') }}",
   method:"POST",
...
$('body').on('click', '.btn_view', function () {
      ...
      $.get("{{ url('reports-me/cg/stakeHolder') }}" +'/' + meeting_id +'/view', function (data) {
