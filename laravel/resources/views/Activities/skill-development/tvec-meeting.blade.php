	  ...
	  <div class="col-12">
	    ...
	    <div class="card">
	      <div class="card-header d-flex p-0">
	        <h3 class="card-title p-3">Meetings between TVEC & Institutes</h3>
	        ...
	        <div class="tab-content">
	          <div class="tab-pane active" id="tab_1">
	            	...
	            	<div class="col-md-8">
	            		<div class="form-group">
						    ...
						    <select name="title_of_action" id="title_of_action" class="form-control">
								...
								<option @if($activity->activity=='Facilitate private sector VTIs  to aware on course accreditation requirements and TVEC standard components into the VT training modules') selected @endif value="{{ $activity->activity}}">{{ $activity->activity }}</option>
								@endforeach
    					   </select>
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="activity_code" id="activity_code" class="form-control">
								<option value="">Select Option</option>
								@foreach($activities as $activity)
								<option @if($activity->code=='3.3.4') selected @endif value="{{ $activity->code}}">{{ $activity->code }}</option>
								@endforeach
    					   </select>
						</div>
	            	</div>
	            ...
	            <div class="row">
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">10. Total Male</label>
						    <input type="number" name="total_male" id="total_male" class="form-control">
						</div>
	            	</div>
	            	<div class="col-md-3">
	            		<div class="form-group">
						    <label for="dm_name">11. Total Female</label>
						    <input type="number" name="total_female" id="total_female" class="form-control">
						</div>
	            	</div>
	            	<div class="col-md-6">
	            		<div class="form-group">
						    <label for="dm_name">12. Number of private VTIs/Professional training institutes </label>
						    <input type="number" name="total_institutes" id="pwd_male" class="form-control">
						</div>
	            	</div>
                ...
                <div class="form-group">
						  ...
						  <tbody>
						    <tr>
						      ...
						      <td><input type="text" name="position[]" class="form-control branch-list"></td>
						      <td><input type="text" name="institute[]" class="form-control branch-list"></td>
						      <td><select name="institute_type[]" class="form-control i-list">			      
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
						    <label for="dm_name">13. Matters discussed</label>
						    <textarea class="textarea" name="matters_discussed" placeholder="Place some text here"
	            ...
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
						    <label for="dm_name">14. Decisions agreed (If any)</label>
						    <textarea class="textarea" name="decisions_agreed" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
						</div>
	            	</div>	            	
	            </div>
	            <div class="row">
	            	<div class="col-md-12">
	            		<div class="form-group">
						    <label for="dm_name">15. Matters to be further followed up</label>
						    <textarea class="textarea" name="matters_to_follow" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
						</div>
	            	</div>	            	
	            </div>
	          	...
	          	<div class="row">
	          		...
	          		<div class="col-md-4">
	          			<div class="form-group">
	          				...
	          				<input type="file" name="meeting_minute" class="form-control" multiple>
	          			</div>	
	          		</div>
	          		<div class="col-md-4">
	          			<div class="form-group">
...
$(document).ready(function(){  
      ...
      $('#add').click(function(){  
           i++;  
           $('#dynamic_field').append('<tr id="row'+i+'"><td><input type="text" name="name[]" class="form-control name-list"></td><td><input type="text" name="gender[]" class="form-control position-list"></td><td><input type="text" name="position[]" class="form-control branch-list"></td><td><input type="text" name="institute[]" class="form-control branch-list"></td><td><select name="institute_type[]" class="form-control i-list"><option value="Private">Private</option><option value="Government">Government</option></select></td><td><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn-flat btn_remove">X</button></td></tr>');  
      });  
...
$(document).ready(function(){
     $("#res_person").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/skill/add-tvec',   
            ...
            success: function(data) {
              ...
              toastr.success('Succesfully Add TVEC Meetng Details ! ', 'Congratulations', {timeOut: 5000});
			  $("#res_person")[0].reset();
