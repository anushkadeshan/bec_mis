...
@section('title','GVT Course Supports |')
@section('content')
	  ...
	  <div class="col-12">
	    ...
	    <div class="card">
	      <div class="card-header d-flex p-0">
	        <h3 class="card-title p-3">Support for course enrollment & directing to Gvt. Institutes </h3>
	        ...
	        <div class="tab-content">
	          <div class="tab-pane active" id="tab_1">
	            ...
	            <div class="row">
	            	<div class="col-md-8">
	            	<?php 
		                  $activitiess = array('Supporting youth to enroll in demand driven VT/professional courses','Direction of youth for government vocational / professional training Centre');

		                  $codes = array('3.1.1','3.1.5');
                 	?>
	            		<div class="form-group">
...
$(document).ready(function(){
     $("#course_support").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/skill/add-course-support',   
