          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab_1">
              ...
              <div class="row">
                ...
                <input type="date" name="date_mou_signed" id="date_mou_signed" class="form-control" value="{{$meeting->date_mou_signed}}">
              ...
              <div class="row">
                ...
                <input type="number" name="bec_contribution" id="bec_contribution" class="form-control prc" value="{{$meeting->bec_contribution}}">
            </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                <label for="dm_name">15. Partner contribution </label>
                <input type="number" name="partner_contribution" id="partner_contribution" class="form-control prc" value="{{$meeting->partner_contribution}}">
            </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                      <label for="dm_name">16. Student contribution </label>
                      <input type="number" name="student_contribution" id="student_contribution" class="form-control prc" value="{{$meeting->student_contribution}}">
                  </div>
                </div>
              </div>
              <div style="width: 100%; height: 20px; border-bottom: 1px solid blue; text-align: center;padding-bottom: 10px">
...
$(document).ready(function(){
     $("#course_support").on('submit' ,function (e){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/skill/update-partnership',   
  ...
  //update
   $(document).ready(function(){
     $(document).on('click' , '#update-part' ,function (){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/skill/update-youth-partnership',
...
//add youth
   $(document).ready(function(){
     $(document).on('click' , '#add2' ,function (){
        ...
        $.ajax({
            type: 'POST',
            url: SITE_URL + '/activity/cg/add-new-partnership-youth',
