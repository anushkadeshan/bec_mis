	            	...
	            	<div class="col-md-8">
	            		...
	            		<div class="form-group">
						    ...
						    <select name="title_of_action" id="title_of_action" class="form-control">
								...
								<option @if($activity->activity=="Review existing training modules of accredited VT/professional institutes locally available") selected @endif value="{{ $activity->activity}}">{{ $activity->activity }}</option>
								@endforeach
    					   </select>
						</div>
	            	</div>
	            	<div class="col-md-4">
	            		<div class="form-group">
						    ...
						    <select name="activity_code" id="activity_code" class="form-control">
								<option value="">Select Option</option>
								@foreach($activities as $activity)
								<option @if($activity->code=="3.3.1") selected @endif value="{{ $activity->code}}">{{ $activity->code }}</option>
								@endforeach
    					   </select>
						</div>
	            	</div>
