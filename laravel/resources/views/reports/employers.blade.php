  ...
  <div class="row">
    ...
    <div class="col-md-9">
      <div class="card card-success card-outline">
                <div class="card-header">
                  <h3 class="card-title">Employer Details <span  class="badge badge-success float-right" id="row_count"></span></h3>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
   var table = $('#example').DataTable( {
      ...
      $('#company_type').on('change', function () {
          ...
          $('#row_count').text(info.recordsDisplay+ ' employers filtered out of  ' +info.recordsTotal);
      } );
