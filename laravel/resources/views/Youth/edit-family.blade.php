	          					...
	          					<div class="form-group">
    								...
    								<select name="district" id="district" class="form-control" data-dependent="ds_division">
    									<option value="">Select Option</option>
     									...
     									<option value="{{ $district->name_en}}" @if($district->name_en==$family->district) selected="selected"@endif>{{ $district->name_en }}</option>
     									@endforeach
    								</select>
   								</div>
	          				</div>
	          				<div class="col-md-4">
		          				<div class="form-group">
    								...
    								<select name="ds_division" id="ds_division" class="form-control">
     									<option value="{{$family->ds_division}}">{{$family->DSD_Name}}</option>
    								</select>
   								</div>
	          				</div>
	          				<div class="col-md-4">
	          					<div class="form-group">
    								...
    								<select name="gn_division" id="gn_division" class="form-control">
     									<option value="{{$family->gn_division}}">{{$family->GN_Office}}</option>
    								</select>
   								</div>
	          				</div>
	          			</div>
	          				<div class="row">
	          					...
	          					<div class="col-md-4">
	          						<div class="form-group">
		                    			...
		                    			<input type="text" class="form-control" id="head_of_household" name="head_of_household" value="{{$family->head_of_household}}">
		                  			</div>
	          					</div>
	          					<div class="col-md-4">
			      					<div class="form-group"	>
	                  					<label for="nic_head_of_household">NIC number of Head of Household</label>
		                    			<input type="text" class="form-control" id="nic_head_of_household" name="nic_head_of_household" value="{{$family->nic_head_of_household}}" >
	                  				</div>
	                  			</div>
	                  			<div class="col-md-4">
	                  				<div class="form-group">
                  						<label for="address">Address</label>
		                    			<textarea name="address" rows="2" class="form-control" id="address">{{$family->address}}</textarea>
                  					</div>
	                  			</div>
	          				</div>
                  				...
                  				<div class="col-md-4">
			      					<div class="form-group">
                  						...
                  						<select name="family_type" class="form-control" id="family_type">
                  							<option value="">Select Option</option>
                  							<option @if($family->family_type=='Samurdhi beneficiary') selected="selected" @endif>Samurdhi beneficiary</option>
                  							<option @if($family->family_type=='Gvt. beneficiary') selected="selected" @endif>Gvt. beneficiary</option>
                  							<option @if($family->family_type=='Plantation Sector') selected="selected" @endif>Plantation Sector</option>
                  							<option @if($family->family_type=='Other') selected="selected" @endif>Other</option>
                  							<option @if($family->family_type=='No any grants') selected="selected" @endif>No any grants</option>
                  						</select>
                  					</div>
	                  			</div>
	                  			<div class="col-md-4">
	                  				<div class="form-group"	>
		                    			...
		                    			<input type="number" class="form-control" id="total_members" name="total_members" value="{{$family->total_members}}" >
	                  				</div>
	                  			</div>
	                  			<div class="col-md-4">
	                  				<div class="form-group"	>
	                  					<label for="nic_head_of_household">Total Family Income</label>
		                    			<input type="number" class="form-control" id="total_income" name="total_income" value="{{$family->total_income}}" >
	                  				</div>
	                  			</div>
                  			</div>
                  			<div class="form-group">
                        <input type="hidden" name="family_id" value="{{$family->id}}">
		          			<input type="button" id="add-family" class="btn btn-primary btn-flat" value="Update">
		          		</div>	
                  		</div>
  ...
  // add family to database
      $(document).ready(function(){
        $(document).on('click', '#add-family', function(){
          ...
          $.ajax({
            type: 'POST',
                url: SITE_URL + '/youth/update-family',
                data: form.serialize(),
