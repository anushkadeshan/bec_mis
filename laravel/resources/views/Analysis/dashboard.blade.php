...
@section('title','Analysis - Job Placement |')
@section('content')
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-2">
       <a href="{{Route('reports-me/job/placements')}}" >
       ...
       <div class="col-sm-4 col-md-2">
       <a href="{{url('reports-me/job/assesment')}}">
        <div class="color-palette-set">
       ...
       <div class="col-sm-4 col-md-2">
       <a href="{{url('reports-me/job/awareness')}}">
        <div class="color-palette-set">
    ...
    <div class="row">
      ...
      <div class="col-sm-4 col-md-2">
       <span style="float: right" class="text-right"><a href="{{ URL::to('youth-placed-in-jobs') }}"><button type="button" class="btn btn-success btn-flat"><i class="fas fa-file-invoice"> View Full Report</i></button></a></span>
    ...
    <br>
	    ...
	    <div class="row">
           ...
           <div class="card card-primary">
             <div class="card-header">
               Employers where Youth Placed <span class="badge badge-info text-right"> {{--count($employers)--}}</span>
             </div>
             <div class="card-body">
      ...
      <div class="row">
          <div class="col-md-4">
           <div class="card card-primary">
             <div class="card-header">
               Company type wise Job Placement <span class="badge badge-info text-right"> {{--count($employers)--}}</span>
             </div>
             <div class="card-body">
