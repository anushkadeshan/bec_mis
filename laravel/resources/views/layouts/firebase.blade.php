    ...
    <div id="wrapper">
        ...
        <div id="sidebar-nav" class="sidebar">
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="{{url('firebase')}}" ><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
                        <li><a href="{{url('firebase-users')}}"  ><i class="lnr lnr-users"></i> <span>Users</span></a></li>
                        <li><a href="{{url('firebase-staff')}}" ><i class="lnr lnr-smile"></i> <span>Staff</span></a></li>
                        <li><a href="{{url('firebase-sessions')}}" class=""><i class="lnr lnr-chart-bars"></i> <span>Sessions</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
